...
import Style from './styles/staff-list-edit-user-table.module.css';

function StaffListEditUserTable() {
    ...
    return (
        <>
            <header className={Style.staffListEditUserTableHeader}>
                <h1>Seleccione un {perfil.nombre_perfil ? singularize(perfil.nombre_perfil.toLowerCase()) : 'Usuario'} para editar</h1>
            </header>
            <main className={Style.staffListEditUserTableMain}>
                {usuario.length > 0 ? (
                    <motion.table className={Style.staffListEditUserTableMainTable} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }}>
                        <thead className={Style.staffListEditUserTableMainTableHead}>
                            <tr>
                                <th>Nombre</th>
                        ...
                        <tbody className={Style.staffListEditUserTableMainTableBody}>
                            {usuario.map((usuario) => (
                                <tr
                    ...
                    <motion.div className={Style.staffListEditUserTableMainAlternative} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }}>
                        <h2>No existen usuarios</h2>
                    </motion.div>
                )}
            </main>
            <footer className={Style.staffListEditUserTableFooter}>
...
export default StaffListEditUserTable;