    ...
    return (
        <>
            ...
            <main className={Style.staffListDeleteUserTableMain}>
                {usuario.length > 0 ? (
                    <motion.table className={Style.staffListDeleteUserTableMainTable} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }}>
                    ...
                    <motion.div className={Style.staffListDeleteUserTableMainAlternative} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }}>
