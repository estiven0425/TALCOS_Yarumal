    ...
    return (
        <>
            ...
            <main className={Style.inventorytListEditWindmillTableMain}>
                {molino.length > 0 ? (
                    <motion.table className={Style.inventorytListEditWindmillTableMainTable} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }}>
                        <thead className={Style.inventorytListEditWindmillTableMainTableHead}>
                            <tr>
                                <th>Nombre</th>
                                <th>Horómetro</th>
                            </tr>
                        </thead>
                        <tbody className={Style.inventorytListEditWindmillTableMainTableBody}>
                            {molino.map((molino) => (
                                <tr
                    ...
                    <motion.div className={Style.inventorytListEditWindmillTableMainAlternative} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }}>
