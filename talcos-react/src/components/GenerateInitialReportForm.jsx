...
function GenerateInitialReportForm() {
  ...
  const [informeFinalPendiente, setInformeFinalPendiente] = useState(null);
  ...
  return (
    <>
      {informeFinalPendiente ? (
        informeFinalPendiente.pendiente ? (
          <>
            <motion.main
              className={Style.generateInitialReportFormAlternativeSecondary}
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ duration: 0.5 }}
            >
              <h1>
                El informe del {informeFinalPendiente.turno} del{" "}
                {format(
            ...
            <motion.footer
              className={
                Style.generateInitialReportFormAlternativeSecondaryfooter
              }
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ duration: 0.5 }}
            >
              <button
                type="button"
                onClick={() => redirectFinishReport(informeFinalPendiente)}
              >
                Finalizar informe
              </button>
            </motion.footer>
                  ...
                  >
                    ...
                    <main className={Style.generateInitialReportFormMain}>
                      ...
                      {molino.map((molinoItem, index) => (
                        <fieldset
                          className={
                            Style.generateInitialReportFormMainSecondary
                          }
                          key={index}
                        >
                          <div
                          ...
                          <div
                            className={
                              Style.generateInitialReportFormMainEspecial
                            }
                          >
                          ...
                          <div>
                            <label htmlFor={`referencia-${index}`}>
                              Referencia
                            </label>
                            <select
                              disabled={!molinoEnabled[index]}
                    ...
                    <footer className={Style.generateInitialReportFormFooter}>
                      <button
                        onClick={() => redirectGenerateReport()}
                        type="button"
                      >
                        Cancelar
                      </button>
                      ...
                      {!serverError ? (
                        ...
                        <motion.span
                          className={
                            Style.generateInitialReportFormValidationServer
                          }
                          initial={{ opacity: 0 }}
                          animate={{ opacity: 1 }}
                          transition={{ duration: 0.5 }}
