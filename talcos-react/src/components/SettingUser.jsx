  ...
  return (
    <>
      {isReady ? (
        <>
          <motion.header
            className={Style.settingUserHeader}
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ duration: 0.5 }}
          >
            <i
              className={`bi bi-person-circle ${Style.settingUserHeaderIcon}`}
            ></i>
            <h2>{nombreUsuario}</h2>
          </motion.header>
          <motion.main
            className={Style.settingUserMain}
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ duration: 0.5 }}
          >
            <table className={Style.settingUserTable}>
              ...
              <tbody className={Style.settingUserTableBody}>
                <tr>
                  ...
                  <td>
                    {correoUsuario !== null ? correoUsuario : "No aplica"}
                  </td>
                  <td>
                    {contratoUsuario !== null ? contratoUsuario : "No aplica"}
                  </td>
                </tr>
              </tbody>
            </table>
          ...
          <motion.footer
            className={Style.settingUserFooter}
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ duration: 0.5 }}
          >
        ...
        <motion.div
          className={Style.settingUserAlternative}
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 0.5 }}
        >
