...
function NotificationMessageSend() {
  ...
  return (
    <>
      <motion.header
        className={Style.notificationMessageSendHeader}
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      <motion.main
        className={Style.notificationMessageSendMain}
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 0.5 }}
      >
        {SendStatus === true ? (
          ...
          <form
            className={Style.notificationMessageSendMainForm}
          ...
          >
            <header>
              ...
              {!serverError ? (
                ...
                <motion.span
                  className={
                    Style.notificationMessageSendMainFormValidationServer
                  }
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  transition={{ duration: 0.5 }}
              ...
              <div>
                <button type="submit">
                  {loading ? (
                    ...
                    <i
                      className={`bi bi-send-fill ${Style.notificationMessageSendMainFormIcon}`}
                    ></i>
                  )}
                </button>
              </div>
