    ...
    return (
        <>
            ...
            <main className={Style.inventorytListEditShiftTableMain}>
                {turno.length > 0 ? (
                    <motion.table className={Style.inventorytListEditShiftTableMainTable} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }}>
                    ...
                    <motion.div className={Style.inventorytListEditShiftTableMainAlternative} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }}>
