...
function StaffEditUserForm() {
  ...
  const sendEditUser = async (e) => {
    ...
    try {
      ...
      await axios.put(`http://${localIP}:3000/usuarios`, {
        ...
        nombre_usuario:
          nombreUsuario === "" ? user.nombre_usuario : nombreUsuario,
        documento_usuario:
          documentoUsuario === "" ? user.documento_usuario : documentoUsuario,
        telefono_usuario:
          telefonoUsuario === "" ? user.telefono_usuario : telefonoUsuario,
        correo_usuario:
          correoUsuario === "" ? user.correo_usuario : correoUsuario,
        contrato_usuario:
  ...
  return (
    <>
      {SendStatus === true ? (
        <motion.div
          className={Style.staffEditUserFormAlternative}
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        <motion.form
          className={Style.staffEditUserForm}
        ...
        >
          <header className={Style.staffEditUserFormHeader}>
            <h1>
              Complete los datos para editar el{" "}
              {perfil.nombre_perfil
                ? singularize(perfil.nombre_perfil.toLowerCase())
                : "Usuario"}
            </h1>
          ...
          <main className={Style.staffEditUserFormMain}>
            ...
            <fieldset className={Style.staffEditUserFormMainEspecial}>
              ...
              <input
                ...
                placeholder={
                  user.contrato_usuario
                    ? user.contrato_usuario
                    : "Ingresa el número de contrato del usuario"
                }
                type="text"
