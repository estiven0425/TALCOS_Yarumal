    ...
    return (
        <motion.nav className={Style.navBar} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }}>
            <section>
                ...
                <Link
                    className={`${Style.navBarReport} ${currentPath === '/report' || currentPath === '/generatereport' ? Style.active : ''}`}
                    to={perfilUsuario === 3 || perfilUsuario === 4 ? '/generatereport' : '/report'}
                >
                ...
                <Link
                    className={`${Style.navBarInventory} ${currentPath === '/inventory' || currentPath === '/fastinventory' ? Style.active : ''}`}
