        ...
        const verifySession = async () => {
            try {
                ...
                const restrictions = {
                    ...
                    3: ['/staff', '/user', '/createuser', '/listedituser', '/edituser', '/listdeleteuser', '/deleteuser', '/report', '/monitoring', '/inventory'],
                    4: ['/staff', '/user', '/createuser', '/listedituser', '/edituser', '/listdeleteuser', '/deleteuser', '/report', '/monitoring', '/inventory'],
                };
