...
CREATE TABLE `registros_ap` (
	...
	`ingreso_roca_registro_ap` DECIMAL(5,2) NOT NULL,
	`bobcat_roca_registro_ap` BIGINT(100) NOT NULL,
	`ingreso_grueso_registro_ap` DECIMAL(5,2) NOT NULL,
	`bobcat_grueso_registro_ap` BIGINT(100) NOT NULL,
	`peso_bobcat_registro_ap` DECIMAL(5,2) NOT NULL,
	`total_roca_registro_ap` DECIMAL(5,2) NOT NULL,
	`total_grueso_registro_ap` DECIMAL(5,2) NOT NULL,
