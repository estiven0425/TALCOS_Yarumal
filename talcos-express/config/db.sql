...
CREATE TABLE `molinos` (
	...
	`horometro_molino` DECIMAL(8,2) NOT NULL,
...
CREATE TABLE `molinos_ap` (
	...
	`horometro_molino_ap` DECIMAL(8,2) NOT NULL,
...
CREATE TABLE `informe_inicial` (
	...
	`horometro_informe_inicial` DECIMAL(8,2) NULL,
...
CREATE TABLE `novedad` (
	...
	`horometro_inicio_paro_novedad` DECIMAL(8,2) NULL,
	`horometro_fin_paro_novedad` DECIMAL(8,2) NULL,
...
CREATE TABLE `informe_final` (
	...
	`horometro_informe_final` DECIMAL(8,2) NOT NULL,
...
CREATE TABLE `registros_ap` (
	...
	`horometro_inicio_registro_ap` DECIMAL(8,2) NOT NULL,
	`horometro_fin_registro_ap` DECIMAL(8,2) NOT NULL,
