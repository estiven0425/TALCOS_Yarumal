...
exports.crearProductoRechazado = async (req, res) => {
    const { nombre_producto_rechazado, cantidad_producto_rechazado, retencion_producto_rechazado } = req.body;
...
exports.actualizarProductoRechazado = async (req, res) => {
    const { id_producto_rechazado, nombre_producto_rechazado, cantidad_producto_rechazado, retencion_producto_rechazado, actividad_producto_rechazado } = req.body;

    try {
        const productoRechazado = await ProductosRechazados.findByPk(id_producto_rechazado);
