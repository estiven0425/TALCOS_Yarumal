...
exports.crearBobCat = async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ error: "Error al crear el BobCat" + error });
  }
};
...
exports.actualizarBobCat = async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ error: "Error al actualizar el BobCat" + error });
  }
};
...
exports.eliminarBobCat = async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ error: "Error al eliminar el bob - cat" + error });
  }
};
