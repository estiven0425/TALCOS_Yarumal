...
exports.crearDespachoComercial = async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ error: "Error al crear el despacho programado" });
  }
};
...
exports.actualizarDespachoComercial = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ error: "Error al actualizar el despacho programado" });
  }
};
...
exports.eliminarDespachoComercial = async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ error: "Error al eliminar el despacho programado" });
  }
};
