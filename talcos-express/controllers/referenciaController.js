...
exports.crearReferencia = async (req, res) => {
    const { nombre_referencia, cantidad_referencia, cliente_referencia } = req.body;
...
exports.actualizarReferencia = async (req, res) => {
    const { id_referencia, nombre_referencia, cantidad_referencia, cliente_referencia, actividad_referencia } = req.body;
